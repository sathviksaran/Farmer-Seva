  ...
  return (
    <div className="flex ml-16 rounded-md h-screen overflow-y-auto" >
      ...
      "
                ...
                {value.name}
                <p><button className='shadow-xl bg-green-600 p-2 text-center text-white translate translate-y-1/3 hover:translate-y-1 rounded-lg group-hover:translate-y-1' onClick={()=>{removeCart(value)}}>remove from cart</button></p>
                </div>
              </div>
            })
          }
